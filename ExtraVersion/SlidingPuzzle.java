...
public class SlidingPuzzle extends JFrame {
	...
	public static void main(String[] args){
		...
		int inputdms = 0;
		while (inputdms<2||inputdms>10){
					String inputstring = JOptionPane.showInputDialog(puzzle,"Setting Sliding Puzzle Dimension:\n" +
					"Please Enter a Dimension Value For The Game!\n" +
					"(Notice: For Stablility Issue, the Dimension Value is LIMITED" +
					"BETWEEN 2 AND 10)", "3");
					if(inputstring==null){System.exit(1);}
					try{
					inputdms = Integer.parseInt(inputstring); 
